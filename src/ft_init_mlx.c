...
/*   Updated: 2025/04/13 16:08:58 by yuocak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	keyboard(int keycode, t_game *game)
{
	if (keycode == ESC)
		mlx_exit("Exit", game);
	else if (keycode == W && game->map->map[game->player_y
			- 1][game->player_x] != '1')
		game->player_y--;
	else if (keycode == A && game->map->map[game->player_y]
		[game->player_x - 1] != '1')
		game->player_x--;
	else if (keycode == D && game->map->map[game->player_y]
		[game->player_x + 1] != '1')
		game->player_x++;
...
void	init_mlx(t_game *game)
{
	...
	game->exit = mlx_xpm_file_to_image(game->mlx,
			"textures/forest-game-exit.xpm", &y, &x);
	game->wall = mlx_xpm_file_to_image(game->mlx,
			"textures/forest-game-wall.xpm", &y, &x);
